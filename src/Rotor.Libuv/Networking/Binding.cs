...
namespace Rotor.Libuv.Networking
{
    public class Binding
    {
        ...
        // Second ctor that doesn't set any fields only to be used by MockBinding
        internal Binding(bool onlyForTesting)
        {
        }
        ...
        unsafe public void write2(UvRequest req, UvStreamHandle handle, Binding.uv_buf_t* bufs, int nbufs, UvStreamHandle sendHandle, uv_write_cb cb)
        {
            req.Validate();
            handle.Validate();
        ...
        private static class NativeMethods
        {
            ...
            [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
            public static extern int uv_idle_start(UvIdleHandle handle, uv_idle_cb idle_cb);
